...
"I found that there is one particular type of Federal Provider Number generated an abnormal highest frequency"
...
"it's 055017 with a frequency of 230"

"I used filter() function to filter a table which only contains type 055017"
